...
export class BooksService {
    ...
    async updateBook (boookId: string, createBookDTO:CreateBookDTO ): Promise<Book>{
        const updatedBook = await this.bookModel.findByIdAndUpdate(boookId, createBookDTO, { new: true});
        return updatedBook;
    }
